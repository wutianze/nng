...
static void
test_mix_wild_card_connect_fail(void)
{
	nng_socket s;
...
void
test_mix_local_address_connect(void)
{
...
void
test_mix_bad_local_interface(void)
{
	nng_socket s1;
	int rv;
...
void
test_mix_non_local_address(void)
{
	nng_socket s1;
...
void
test_mix_malformed_address(void)
{
	nng_socket s1;
...
void
test_mix_keep_alive_option(void)
{
	nng_socket   s;
	nng_dialer   d;
	nng_listener l;
...
NUTS_TESTS = {
	...
	{ "mix wild card connect fail", test_mix_wild_card_connect_fail },
	{ "mix wild card bind", test_mix_wild_card_bind },
	{ "mix port zero bind", test_mix_port_zero_bind },
	{ "mix local address connect", test_mix_local_address_connect },
	{ "mix bad local interface", test_mix_bad_local_interface },
	{ "mix non-local address", test_mix_non_local_address },
	{ "mix malformed address", test_mix_malformed_address },
	{ "mix no delay option", test_mix_no_delay_option },
	{ "mix keep alive option", test_mix_keep_alive_option },
	{ "mix recv max", test_mix_recv_max },
	{ NULL, NULL },
};
