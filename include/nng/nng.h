...
NNG_DECL int      nng_msg_header_append_u8(nng_msg *, uint8_t);
...
NNG_DECL int      nng_msg_header_insert_u8(nng_msg *, uint8_t);
...
NNG_DECL int      nng_msg_header_chop_u8(nng_msg *, uint8_t *);
...
NNG_DECL int      nng_msg_header_trim_u8(nng_msg *, uint8_t *);
